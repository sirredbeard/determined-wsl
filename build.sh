...
sudo debootstrap --arch arm64 --variant=minbase --include=sudo,curl,systemd,postgresql,locales,ca-certificates,apt-utils,wget jammy $builddir http://ports.ubuntu.com/ubuntu-ports/
